...
/// <summary>
/// Represents a bidirectional, one-to-one mapping between keys and values, allowing efficient lookup in both
/// directions.
/// </summary>
/// <remarks>A bijection ensures that each key is associated with exactly one value, and each value is associated
