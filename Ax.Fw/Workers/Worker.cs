...
namespace Ax.Fw.Workers
{
    ...
    {
        /// <summary>
        /// Starts new <see cref="Worker"/>. This team will do work pieces in sequential order.
        /// </summary>
        ...
        /// <returns></returns>
        public static Worker<TJob> Run<TJob>(
        ...
        {
            return new Worker<TJob>(_jobsFlow, _jobRoutine, _penaltyForFailedJobs, _lifetime, _scheduler);
        }
    }

    public class Worker<TJob> : ITeam<TJob>
    {
