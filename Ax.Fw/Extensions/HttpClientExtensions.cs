...
namespace MCDis.Design.Network.Extensions
{
   public static class HttpClientExtensions
   {
      ...
      {
         return await DownloadWithResume(_client, _req, _ => _delayBetweenAttempts, _attemptsNum, _minimumConnectionSpeedBytesPerSecond, _token);
      }
      ...
      public static async Task<Stream> DownloadWithResume(this HttpClient _client,
         ...
         CancellationToken _token)
      {
         return (await DownloadWithResumeEx(_client, _req, _delayForAttempt, _attemptsNum, _minimumConnectionSpeedBytesPerSecond, _token)).Stream;
      }
      ...
      public static async Task<StreamWithHeaders> DownloadWithResumeEx(this HttpClient _client,
         ...
         CancellationToken _token)
      {
         return await DownloadWithResumeEx(_client, _req, _ => _delayBetweenAttempts, _attemptsNum, _minimumConnectionSpeedBytesPerSecond, _token);
      }
