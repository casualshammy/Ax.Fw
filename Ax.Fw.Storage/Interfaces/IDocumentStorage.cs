...
public interface IDocumentStorage
{
    ...
    DocumentEntry WriteDocument<T>(string _namespace, int _key, T _data) where T : notnull;
    DocumentEntry WriteDocument(string _namespace, string _key, JToken _data);
